...
The following quantization data was successfully extracted:

**Full-Rate:**
- Annex E: Gain quantizer (64 levels) -- selected values extracted:
  - b2=0: -2.842205, b2=16: -0.147249, b2=32: 2.653909, b2=63: 8.695827
- Annex F: Gain bit allocation by L (9..56) -- structure described, full table not extracted
- Annex G: HOC bit allocation by L (9..56) -- structure described, full table not extracted
- Annex J: Spectral block lengths J1..J6 by L -- structure described
...
The following large numerical tables were NOT fully extracted from the PDF text.
These are multi-page tables of floating-point values that do not extract reliably
from PDF text extraction:

| Table | Annex | Size | TIA Source |
|-------|-------|------|------------|
| Full gain quantizer | E | 64 entries x 1 value | BABA-A Annex E |
| Full gain bit allocation | F | 48 rows x 6 cols | BABA-A Annex F |
| Full HOC bit allocation | G | 48 rows x variable cols | BABA-A Annex G |
| Full interleaving table | H | 72 rows x 2 cols | BABA-A Annex H |
