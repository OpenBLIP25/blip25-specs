...
per L̂; Annex G entry counts are contiguous from b_8.

### 12.1 Annex E — Gain Quantizer Levels

6-bit non-uniform quantizer for the overall log-gain G̃_1. Encoder selects
b̂_2 ∈ [0, 63] = index of the entry nearest G̃_1.

```rust
/// BABA-A Annex E — Gain Quantizer Levels (page 84).
/// 6-bit non-uniform quantizer for the overall gain G̃_1.
/// Encoder picks b̂_2 = index of nearest entry to G̃_1; decoder outputs this value.
pub const IMBE_GAIN_QUANTIZER: [f32; 64] = [
    -2.842205,  // b2=0
    -2.694235,  // b2=1
    -2.558260,  // b2=2
    -2.382850,  // b2=3
...
/// BABA-A Annex J — Log Magnitude Prediction Residual Block Lengths (page 105).
```

### 12.2 Annex F — Bit Allocation and Step Size for Transformed Gain

For each L̂ ∈ [9, 56], five (B̂_m, Δ̂_m) pairs quantizing the DCT coefficients
b̂_3..b̂_7 of the transformed gain vector. B̂_m is the bit count (1..10);
Δ̂_m is the uniform quantizer step size.

```rust
/// For each L̃ in 9..=56, five (B̃_m, Δ̃_m) pairs for m = 3, 4, 5, 6, 7
/// (quantizing DCT coefficients b̂_3 through b̂_7 of the transformed gain vector).
/// B̃_m is the bit count, Δ̃_m is the uniform quantizer step size.
/// Index = L̃ - 9.
pub const IMBE_GAIN_ALLOCATION: [[(u8, f32); 5]; 48] = [
    [(10, 0.003100), (9, 0.004020), (9, 0.003360), (9, 0.002900), (9, 0.002640)],  // L=9
    [(9, 0.006200), (9, 0.004020), (8, 0.006720), (8, 0.005800), (8, 0.005280)],  // L=10
    [(8, 0.012400), (8, 0.008040), (8, 0.006720), (7, 0.011600), (7, 0.010560)],  // L=11
    [(8, 0.012400), (7, 0.016080), (7, 0.013440), (7, 0.011600), (7, 0.010560)],  // L=12
    [(7, 0.024800), (7, 0.016080), (7, 0.013440), (6, 0.021750), (6, 0.019800)],  // L=13
    [(7, 0.024800), (6, 0.030150), (6, 0.025200), (6, 0.021750), (6, 0.019800)],  // L=14
    [(7, 0.024800), (6, 0.030150), (6, 0.025200), (6, 0.021750), (5, 0.036960)],  // L=15
    [(6, 0.046500), (6, 0.030150), (6, 0.025200), (5, 0.040600), (5, 0.036960)],  // L=16
    [(6, 0.046500), (6, 0.030150), (5, 0.047040), (5, 0.040600), (5, 0.036960)],  // L=17
    [(6, 0.046500), (5, 0.056280), (5, 0.047040), (5, 0.040600), (5, 0.036960)],  // L=18
    [(6, 0.046500), (5, 0.056280), (5, 0.047040), (4, 0.058000), (4, 0.052800)],  // L=19
    [(6, 0.046500), (5, 0.056280), (5, 0.047040), (4, 0.058000), (4, 0.052800)],  // L=20
    [(5, 0.086800), (5, 0.056280), (5, 0.047040), (4, 0.058000), (4, 0.052800)],  // L=21
    [(5, 0.086800), (5, 0.056280), (4, 0.067200), (4, 0.058000), (4, 0.052800)],  // L=22
    [(5, 0.086800), (4, 0.080400), (4, 0.067200), (4, 0.058000), (4, 0.052800)],  // L=23
    [(5, 0.086800), (4, 0.080400), (4, 0.067200), (4, 0.058000), (4, 0.052800)],  // L=24
    [(5, 0.086800), (4, 0.080400), (4, 0.067200), (4, 0.058000), (3, 0.085800)],  // L=25
    [(5, 0.086800), (4, 0.080400), (4, 0.067200), (3, 0.094250), (3, 0.085800)],  // L=26
    [(5, 0.086800), (4, 0.080400), (4, 0.067200), (3, 0.094250), (3, 0.085800)],  // L=27
    [(4, 0.124000), (4, 0.080400), (4, 0.067200), (3, 0.094250), (3, 0.085800)],  // L=28
    [(4, 0.124000), (4, 0.080400), (4, 0.067200), (3, 0.094250), (3, 0.085800)],  // L=29
    [(4, 0.124000), (4, 0.080400), (4, 0.067200), (3, 0.094250), (3, 0.085800)],  // L=30
    [(4, 0.124000), (4, 0.080400), (3, 0.109200), (3, 0.094250), (3, 0.085800)],  // L=31
    [(4, 0.124000), (4, 0.080400), (3, 0.109200), (3, 0.094250), (3, 0.085800)],  // L=32
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (3, 0.094250), (3, 0.085800)],  // L=33
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (3, 0.094250), (3, 0.085800)],  // L=34
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (3, 0.094250), (3, 0.085800)],  // L=35
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (3, 0.094250), (3, 0.085800)],  // L=36
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (3, 0.094250), (2, 0.112200)],  // L=37
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (3, 0.094250), (2, 0.112200)],  // L=38
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (3, 0.094250), (2, 0.112200)],  // L=39
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (3, 0.094250), (2, 0.112200)],  // L=40
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=41
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=42
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=43
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=44
    [(4, 0.124000), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=45
    [(3, 0.201500), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=46
    [(3, 0.201500), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=47
    [(3, 0.201500), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=48
    [(3, 0.201500), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=49
    [(3, 0.201500), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=50
    [(3, 0.201500), (3, 0.130650), (3, 0.109200), (2, 0.123250), (2, 0.112200)],  // L=51
    [(3, 0.201500), (3, 0.130650), (2, 0.142800), (2, 0.123250), (2, 0.112200)],  // L=52
    [(3, 0.201500), (3, 0.130650), (2, 0.142800), (2, 0.123250), (2, 0.112200)],  // L=53
    [(3, 0.201500), (3, 0.130650), (2, 0.142800), (2, 0.123250), (2, 0.112200)],  // L=54
    [(3, 0.201500), (3, 0.130650), (2, 0.142800), (2, 0.123250), (2, 0.112200)],  // L=55
    [(3, 0.201500), (3, 0.130650), (2, 0.142800), (2, 0.123250), (2, 0.112200)]  // L=56
];
```

### 12.3 Annex G — Higher-Order DCT Coefficient Bit Allocation

For each L̂ ∈ [9, 56], a variable-length list of entries `(C_i, C_k, b_m, B_m)`:
- `C_{i,k}` identifies the k-th DCT coefficient of block i (i ∈ [1, 6])
- `b_m` is the voice-parameter element index (starts at 8 for each L̂)
- `B_m` is the bit count (0..10; 0 means the coefficient is not transmitted)

Entry count grows by 1 per L̂, from 3 entries at L̂=9 up to 50 entries at L̂=56
(equal to L̂ − 6, which matches sum(J̃_i) − 6 per Annex J). Each L̂'s entries
have `b_m` starting at 8 and incrementing by 1.

```rust
/// BABA-A Annex G — Bit Allocation for Higher Order DCT Coefficients (pages 89–101).
/// For each L̃ in 9..=56, a variable-length list of (C_i, C_k, b_m, B_m) entries,
/// where C_{i,k} identifies the k-th DCT coefficient of block i (1..=6), b_m is the
/// voice-parameter element index (starts at 8), and B_m is the bit count.
/// Entry count = L̃ − 6, ranging from 3 (L=9) to 50 (L=56).
/// Index = L̃ - 9.
pub const IMBE_HOC_ALLOCATION: &[&[(u8, u8, u8, u8)]] = &[
    &[(4, 2, 8, 9), (5, 2, 9, 8), (6, 2, 10, 7)],  // L=9 (3 entries)
    &[(3, 2, 8, 9), (4, 2, 9, 7), (5, 2, 10, 6), (6, 2, 11, 5)],  // L=10 (4 entries)
    &[(2, 2, 8, 9), (3, 2, 9, 7), (4, 2, 10, 6), (5, 2, 11, 5), (6, 2, 12, 4)],  // L=11 (5 entries)
    &[(1, 2, 8, 8), (2, 2, 9, 7), (3, 2, 10, 6), (4, 2, 11, 5), (5, 2, 12, 4), (6, 2, 13, 3)],  // L=12 (6 entries)
    &[(1, 2, 8, 7), (2, 2, 9, 7), (3, 2, 10, 6), (4, 2, 11, 5), (5, 2, 12, 4), (6, 2, 13, 3), (6, 3, 14, 3)],  // L=13 (7 entries)
    &[(1, 2, 8, 7), (2, 2, 9, 7), (3, 2, 10, 5), (4, 2, 11, 4), (5, 2, 12, 4), (5, 3, 13, 3), (6, 2, 14, 4), (6, 3, 15, 3)],  // L=14 (8 entries)
    &[(1, 2, 8, 6), (2, 2, 9, 7), (3, 2, 10, 5), (4, 2, 11, 4), (4, 3, 12, 4), (5, 2, 13, 3), (5, 3, 14, 3), (6, 2, 15, 3), (6, 3, 16, 3)],  // L=15 (9 entries)
    &[(1, 2, 8, 6), (2, 2, 9, 6), (3, 2, 10, 5), (3, 3, 11, 4), (4, 2, 12, 4), (4, 3, 13, 3), (5, 2, 14, 3), (5, 3, 15, 3), (6, 2, 16, 3), (6, 3, 17, 2)],  // L=16 (10 entries)
    &[(1, 2, 8, 3), (1, 3, 9, 2), (1, 4, 10, 2), (1, 5, 11, 1), (1, 6, 12, 1), (1, 7, 13, 1), (1, 8, 14, 1), (1, 9, 15, 0), (2, 2, 16, 3), (2, 3, 17, 2), (2, 4, 18, 2), (2, 5, 19, 1), (2, 6, 20, 1), (2, 7, 21, 1), (2, 8, 22, 1), (2, 9, 23, 0), (3, 2, 24, 2), (3, 3, 25, 2), (3, 4, 26, 1), (3, 5, 27, 1), (3, 6, 28, 1), (3, 7, 29, 1), (3, 8, 30, 1), (3, 9, 31, 0), (4, 2, 32, 2), (4, 3, 33, 2), (4, 4, 34, 1), (4, 5, 35, 1), (4, 6, 36, 1), (4, 7, 37, 0), (4, 8, 38, 0), (4, 9, 39, 0), (5, 2, 40, 2), (5, 3, 41, 1), (5, 4, 42, 1), (5, 5, 43, 1), (5, 6, 44, 1), (5, 7, 45, 0), (5, 8, 46, 0), (5, 9, 47, 0), (5, 10, 48, 0), (6, 2, 49, 2), (6, 3, 50, 1), (6, 4, 51, 1), (6, 5, 52, 1), (6, 6, 53, 0), (6, 7, 54, 0), (6, 8, 55, 0), (6, 9, 56, 0), (6, 10, 57, 0)]  // L=56 (50 entries)
];
```
...
symbol index (0..71), the two entries give `((vector, bit), (vector, bit))`
for the symbol's bit_1 (MSB) and bit_0 (LSB) respectively.

**OCR correction:** The PDF prints "c9(5)" at symbol 51's right position;
this was corrected to "c0(5)" after verifying that c0(5) was the only
missing bit and c9 does not exist (only c0..c7 are defined).

```rust
/// codewords (23 bits each); 4..=6 are [15,11] Hamming codewords (15 bits each);
/// 7 is uncoded (7 bits).
/// OCR note: PDF printed "c9(5)" at symbol 51 right-bit; corrected to "c0(5)"
/// (verified: all 144 bit positions covered exactly once after the fix).
pub const IMBE_INTERLEAVE: [((u8, u8), (u8, u8)); 72] = [
    ((0, 22), (1, 21)),  // symbol 0
    ((2, 20), (3, 19)),  // symbol 1
    ((4, 10), (5, 1)),  // symbol 2
    ((1, 20), (0, 21)),  // symbol 3
...
Each row sums exactly to L̂.

```rust
/// BABA-A Annex J — Log Magnitude Prediction Residual Block Lengths (page 105).
/// For each L̃ in 9..=56, six block lengths J̃_1..J̃_6 that partition the
/// L̃ spectral amplitude prediction residuals into 6 DCT blocks. Each row sums to L̃.
/// Index = L̃ - 9.
pub const IMBE_BLOCK_LENGTHS: [[u8; 6]; 48] = [
    [1, 1, 1, 2, 2, 2],  // L=9
    [1, 1, 2, 2, 2, 2],  // L=10
    [1, 2, 2, 2, 2, 2],  // L=11
    [2, 2, 2, 2, 2, 2],  // L=12
