...
The functions takes a 16 bit integer as an argument, and returns four 16-bit
values for the corresponding code word.
******************************************************************************/
#include "bch.h"

void bch_64_encode( int in_word, int * code_word_out )
{
    static int matrix[16][4] = {0x8000, 0xcd93, 0x0bdd, 0x3b2a,
    ...
    static int code_word_mask[16] = {0x8000,
                                     0x4000,
                                     0x2000,
                                     0x1000,
                                     0x0800,
